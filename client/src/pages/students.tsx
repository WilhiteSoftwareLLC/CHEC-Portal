  ...
  const handleExportSelected = () => {
    ...
    const csvRows = [
      ...
      ...selectedStudentsData.map((student: any) => [
        ...
        student.gradYear || "",
        student.birthdate ? new Date(student.birthdate).toLocaleDateString('en-US', { timeZone: 'UTC' }) : "",
        student.registeredOn ? new Date(student.registeredOn).toLocaleDateString('en-US', { timeZone: 'UTC' }) : "",
        `"${student.comment1 || ""}"`,
